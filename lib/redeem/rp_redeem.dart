...
import 'package:temp/buildBalance.dart';
...
class RPScreen extends StatefulWidget {
  const RPScreen({Key? key}) : super(key: key);

  @override
  State<RPScreen> createState() => _RPScreenState();
}

class _RPScreenState extends State<RPScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("Rakuten Points Redeem"),
              ...
              FloatingActionButton.extended(
                onPressed: () async {
                  ...
                  if (false) {
                    ...
                    await redeem_rp_post(amount);
                    myHomePageState.setState(() {});
                    rakutenPointsScreenState.setState(() {});
                    if (jsonres['status'] == 0) {
                      showDialog(
                          context: context,
                          builder: (context) {
