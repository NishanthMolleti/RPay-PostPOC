...
late _cashBackScreenState cashBackScreenState;

class cashBackScreen extends StatefulWidget {
  @override
  State<cashBackScreen> createState() {
    cashBackScreenState = _cashBackScreenState();
    return cashBackScreenState;
  }
}

class _cashBackScreenState extends State<cashBackScreen> {
  String type = "Cash Back";
  _cashBackScreenState();
  @override
